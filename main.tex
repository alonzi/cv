...
\item [$\bullet$] R. Alvarado, {\bf L. P. Alonzi}. "The Virginia Model of Data Science: Humans, Data, Machines" Academic Data Science Alliance Annual Meeting, https://adsa.pubpub.org/proceedings-of-the-2024-adsa-annual-meeting, (October 2024). 
...
\subsection*{MSDS}
\begin{itemize}
\item [$\bullet$] Isabella Lu, University of Virginia, Graduated MSDS 2026, Current: Student
\item [$\bullet$] Mike Yang, University of Virginia, Graduated MSDS 2019, Current:
\item [$\bullet$] Sai Leela Krishna Prasanth, University of Virginia, Graduated MSDS 2018, Current:
...
\item [$\bullet$] Isabella Lu, UVA. $CJDTI$
\item [$\bullet$] Rachel Seo, UVA. $CJDTI$
\item [$\bullet$] Jonas Lee, UVA. $CJDTI$
\item [$\bullet$] Saiesha Gohil, UVA. $CJDTI$
\item [$\bullet$] Mitchell Palmer, UVA. $CJDTI$
\item [$\bullet$] Jay Sorkin, UVA. $CJDTI$
\item [$\bullet$] Kevin Villalobos, UVA. $CJDTI$
\item [$\bullet$] Ryan Yates, UVA. $CJDTI$
\end{itemize}

\section*{Funded and Under Review Grant Proposals as PI/Co-PI}
\begin{itemize}

\item[$\bullet$] CJDTI Partner Support (2025) \$3,000 
\begin{itemize}
\item[$\bullet$] (PI) {\bf L.P.Alonzi}
\item[$\bullet$] Offender Aid and Restoration (OAR)
\end{itemize}

\item[$\bullet$] Community Engaged Service Learning Grant (2026) \$7,000 
\begin{itemize}
\item[$\bullet$] (PI) {\bf L.P.Alonzi}
\item[$\bullet$] UVA Office of Academic Outreach
\item[$\bullet$] For: SYS 4054 Sp26
\end{itemize}

\item[$\bullet$] Community Engaged Service Learning Grant (2025) \$7,000 
\begin{itemize}
\item[$\bullet$] (PI) {\bf L.P.Alonzi}
\item[$\bullet$] UVA Office of Academic Outreach
\item[$\bullet$] For: SYS 4053 Fa25
\end{itemize}
